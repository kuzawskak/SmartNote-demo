             ...
             try
             {
                    if(requestnumber == Constants.UploadPhotos_Code)
                    {
                          ...
                          if(sucess)
                          {
                                 ...
                                 Intent i=new Intent(UploadPhotos_Activity.this,UploadPhotos_Activity.class);
                                 startActivity(i);
                                 finish();
                          }
                    }
      ...
      public void BTB_ClickEvent(View v)
      {
             ...
             else if (id==R.id.btn_upload)
             {
                    if(mLoggedIn)
                    {
                          ...
                          {                                
                                 Upload upload = new Upload(Constants.UploadPhotos_Code,UploadPhotos_Activity.this, mApi, PHOTO_DIR,listFile);
                                 upload.execute();
                          }
                          else
                          {
